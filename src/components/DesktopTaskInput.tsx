          ...
          {newTask.trim() && (
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="flex items-center gap-1">Clear input <kbd className="pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100">Esc</kbd></p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          )}
          ...
          <Tooltip>
            ...
            <TooltipContent>
              {!newTask.trim() ? (
                ...
                <p className="flex items-center gap-1">Add task <kbd className="pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100">Enter</kbd></p>
              )}
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
