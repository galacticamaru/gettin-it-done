      ...
      >
          ...
          {newTask.trim() && (
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>Clear <kbd className="ml-1 text-[10px] bg-muted px-1 rounded border text-foreground font-sans">ESC</kbd></p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          )}
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              <p>{!newTask.trim() ? 'Task description is required' : <>Add task <kbd className="ml-1 text-[10px] bg-muted px-1 rounded border text-foreground font-sans">ENTER</kbd></>}</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </form>
